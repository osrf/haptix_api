...
// get sim info
hxResult hxs_getinfo(int target, hxSimInfo* siminfo);


// get information about bodies
hxResult hxs_getbody(int target, hxBody* body);


// get information about joints
hxResult hxs_getjoint(int target, hxJoint* joint);


// get information about active contacts
hxResult hxs_getcontact(int target, hxContact* contact);
...
hxResult hxs_getjacobian(int target, int link, const float* point, float* jacobian);
...
hxResult hxs_setstate(int target, const hxBody* body, const hxJoint* joint);
...
hxResult hxs_updatedirect(int target, const float* torque, hxSensor* sensor, int flg_sleep);
